...
def integrate_with_assistant():
    authenticator = IAMAuthenticator('kDurk5AGZc1tKNyF-pmOQkJxv8gxUHzk-knFSCTdSink')
    ...
    assistant_id='dd3dfb41-08cf-49dc-9eab-53310fdeef86'
    ).get_result()
...
def on_close(ws):
    ...
    if "exit" in transcript:
        exit()
    elif old_transcript != transcript:
